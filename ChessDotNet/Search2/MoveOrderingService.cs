...
namespace ChessDotNet.Search2
{
    ...
    {
        public void OrderNextMove(int currentIndex, Move[] moves, int moveCount, int ply, Move pvMove, uint[,] killers, int[,,] history)
        {
        ...
        private int CalculateMoveScore(Move move, int ply, Move principalVariationMove, uint[,] killers, int[,,] history)
        {
            //return 0;
